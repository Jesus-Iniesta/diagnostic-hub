...
import classes from './AlumnoSidebar.module.css';
...
interface AlumnoSidebarProps {
  active: AlumnoSidebarItemId;
  collapsed?: boolean;
  onNavigate?: () => void;
}

function nombreIniciales(nombre: string, apellidoPaterno: string): string {
      ...
      <div>
        <Group className={classes.brand} gap="sm" wrap="nowrap">
          ...
          <div className={classes.brandText}>
            ...
            <Text className={classes.brandSubtitle}>Alumno</Text>
          </div>
        </Group>
